...
const ReporteVentasSem = (props) => {
  ...
  useEffect(() => {
    const semana = router.query.semana;
    const mes = router.query.mes;
    const anio = router.query.anio;
    fetchVentas(semana, mes, anio);
  }, []);
