      ...
      <div className="reporte-ventas-container">
        ...
        <div className="reporte-main">
          ...
          <div className="reporte-title">
            <br></br>
            <h1 className="reporte-title-h1">Reporte de ventas del año {router.query.anio}</h1>
            <br></br>
            <br></br>
          </div>
...
export default ReporteVentasAño;